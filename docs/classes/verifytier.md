...
```typescript
class VerifyTier extends ITierV2 
```
...
|  [connect](./verifytier.md#connect-property) | `(signer: Signer) => VerifyTier` | Conncect to this VerifyTier contract with another signer<br></br>*Overrides [ITierV2.connect](./itierv2.md#connect-property)* |
