...
export interface FixedPointMathOpsTestInterface extends utils.Interface {
  functions: {
...
export interface FixedPointMathOpsTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FixedPointMathOpsTestInterface;
