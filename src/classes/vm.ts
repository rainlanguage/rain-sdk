...
export class VM {
  ...
  public static combiner(
    ...
    const NumberOfSources = options?.numberOfSources != undefined ? options.numberOfSources : 1;
    let sourceModify1;
    let sourceModify2;
