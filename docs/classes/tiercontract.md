...
|  [isChild](./factorycontract.md#isChild-property-static) | `(signer: Signer, maybeChild: string) => Promise<boolean>` | Checks if address is registered as a child contract of this contract in a specific network.<br></br><i>Inherited from [FactoryContract.isChild](./factorycontract.md#isChild-property-static)</i> |
