...
An Escrow contract for ERC20 tokens to be deposited and withdrawn against redeemableERC20 tokens from a specific `Sale`<!-- -->.
...
|  [withdraw](./redeemableerc20claimescrow.md#withdraw-property) | `(supply: BigNumberish, overrides?: TxOverrides) => Promise<ContractTransaction>` | The successful handover of a `deposit` to a recipient. |
