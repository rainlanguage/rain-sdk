...
export interface ERC20TransferTierFactoryInterface extends utils.Interface {
  functions: {
...
export interface ERC20TransferTierFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20TransferTierFactoryInterface;
