...
|  --- | --- | --- | --- |
|  [afterBlockNumberConfig](./rain-sdk.sale.afterblocknumberconfig.md) | <code>static</code> | (blockNumber: number) =&gt; [StateConfig](./rain-sdk.stateconfig.md) | Create a condition as VM state configuration to that is true after a <code>blockNumber</code> in the chain. |
...
|  [connect](./rain-sdk.sale.connect.md) |  | (signer: Signer) =&gt; [Sale](./rain-sdk.sale.md) | Connect the current instance to a new signer |
