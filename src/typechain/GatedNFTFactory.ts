...
export interface GatedNFTFactoryInterface extends utils.Interface {
  functions: {
    "createChild(bytes)": FunctionFragment;
    "createChildTyped((string,string,string,string,string,bytes32,bytes32),address,uint256,uint256,uint8,uint256,address,uint256)": FunctionFragment;
...
export interface GatedNFTFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GatedNFTFactoryInterface;
