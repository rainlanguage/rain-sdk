...
export const OpMeta: Map<number, IOpMeta> = new Map([
    ...
    [
        2,
        {
            ...
            name: 'CONTEXT',
            description: 'Inserts an argument passed to a contracts function into the stack',      
            pushes: pnp.one,
            pops: pnp.zero, 
            isZeroOperand: false,
            jsvmfn: function(
            ...
            data: {
                ...
                parameters: [
                    ...
                    },
                    {
                        spread: false,
                        name: "loopSize",
                        description: "Defines the number of times the values are split into half, 256bit(0)-> 128bit(1) -> 64bit(2) -> 32bit(3)"
                    },
                    {
                        spread: true,
                        name: "values",
    ...
    [
        21,
        {
            ...
            aliases: ['SCALEBY'],
            data: {
                escription: 'Rescale an arbitrary fixed point number by some OOMs.',
                category: "math",
                ...
                parameters: [
                    {
                        ...
                        description: "The decimal point to up or down by, this value is complement 2's."
                    },
                    {
                        spread: false,
                        name: "value",
    ...
    [
        44,
        {
            ...
            data: {
                ...
                category: "tier",
                example: "select_lte(0 1 block_timestamp() itierv2_report(tierAddress account) itierv2_report(tierAddress account))",
                parameters: [
                    {
                        spread: false,
                        name: "logic",
    ...
    [
        45,
        {
            ...
            data: {
                ...
                category: "tier",
                example: "update_times_for_tier_range(0 8 block_timestamp() itierv2_report(0x....1 0x....2))",
                parameters: [
                    {
                        spread: false,
                        name: "start tier",
