...
export interface SaleFactoryInterface extends utils.Interface {
  functions: {
    ...
    "createChildTyped(((bytes[],uint256[],uint256,uint256),(bytes[],uint256[],uint256,uint256),(bytes[],uint256[],uint256,uint256),address,address,uint256,uint256,uint256),((string,string,address,uint256),address,uint256,address))": FunctionFragment;
