...
export interface TokenOpsTestInterface extends utils.Interface {
  functions: {
    "run()": FunctionFragment;
    "runLength(uint256)": FunctionFragment;
    "runState()": FunctionFragment;
  };

  encodeFunctionData(functionFragment: "run", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "runLength",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(functionFragment: "runState", values?: undefined): string;

  decodeFunctionResult(functionFragment: "run", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "runLength", data: BytesLike): Result;
...
export interface TokenOpsTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenOpsTestInterface;
