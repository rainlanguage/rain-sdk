...
|  [setTier](./rain-sdk.erc20balancetier.settier.md) |  | (account: string, endTier: BigNumberish, data: BytesLike, overrides?: [TxOverrides](./rain-sdk.txoverrides.md)<!-- -->) =&gt; Promise&lt;never&gt; | It is NOT implemented in BalanceTiers. Always will throw an error |
