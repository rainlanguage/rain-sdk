...
export interface StandardStateBuilderInterface extends utils.Interface {
  functions: {
...
export interface StandardStateBuilder extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StandardStateBuilderInterface;
