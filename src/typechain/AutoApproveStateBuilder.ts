...
export interface AutoApproveStateBuilderInterface extends utils.Interface {
  functions: {
...
export interface AutoApproveStateBuilder extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AutoApproveStateBuilderInterface;
